...
const resources = {
  ...
  ko: {
    translation: {
      ...
      media: { progress: "진행", repeatOne: "반복", previousTrack: "이전", playPause: "재생/일시정지", nextTrack: "다음", next: "다음", shuffle: "셔플", volume: "볼륨", collapse: "접기", expandPanel: "펼치기" },
  ...
  hi: {
    translation: {
      ...
      media: { progress: "प्रगति", repeatOne: "दोहराएं", previousTrack: "पिछला", playPause: "प्ले/पॉज़", nextTrack: "अगला", next: "अगला", shuffle: "शफल", volume: "वॉल्यूम", collapse: "समेटें", expandPanel: "फैलाएं" },
  ...
  ar: {
    translation: {
      ...
      media: { progress: "التقدم", repeatOne: "تكرار", previousTrack: "السابق", playPause: "تشغيل/إيقاف مؤقت", nextTrack: "التالي", next: "التالي", shuffle: "عشوائي", volume: "الصوت", collapse: "طي", expandPanel: "توسيع" },
